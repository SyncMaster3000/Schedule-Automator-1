...
// (вместо docxtemplater + бинарного шаблона — так формат воспроизводится надёжнее).
const {
  Document,
  Packer,
  Paragraph,
...
// data: {
//   program: {...}, periods: [...], teachersById, roomsById, groupsById,
//   items: [...] (отсортированы по дате/времени), groupColumn: bool
// }
